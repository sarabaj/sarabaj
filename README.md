...
- UI/UX Design: User Interface Design, User Experience Design, Prototyping, Wireframing
- AI & Data: Machine Learning, NLP, Data Analysis
- Cloud: Cloud Fundamentals, AWS Basics
- Testing & QA: Selenium, Cypress, Playwright, Software Testing, Test Automation
- Tools: Git, GitHub, Jira, Excel, VS Code, Figma

## 🚀 Featured Projects

I am currently updating my GitHub repositories and preparing selected projects with clear documentation, screenshots, and setup instructions.
